...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', action='store', type = str, default='./img_and_cnn',
    ...
    for image_cnn in l_strip:
        ...
        file_png=os.path.join(data_dir,image_cnn.split()[1])
        file_cnn=os.path.join(data_dir,image_cnn.split()[2])
